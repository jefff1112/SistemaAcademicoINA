// Componente GestionConstancias (Administrador): emision, edicion, anulacion y consulta de constancias
// (estudio, conducta e incapacidad/permiso) para Administrador.
...
const GestionConstancias = () => {
    ...
    return (
        <DashboardLayout title="Constancias - Administrador">
            <style>{`
