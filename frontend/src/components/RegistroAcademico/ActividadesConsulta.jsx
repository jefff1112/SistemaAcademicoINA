...
const ActividadesConsultaRegistro = () => {
    const { user } = useAuth();
            ...
            <div className="actividades-consulta-container">
                <div className="consulta-header">
                    ...
                    <p className="subtitle">
                        Visualización de actividades y sub-actividades configuradas por los docentes (solo lectura) - Registro Académico
                    </p>
                </div>
...
export default ActividadesConsultaRegistro;
