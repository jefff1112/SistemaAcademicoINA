...
const CuadroAuxiliarConsultaRegistro = () => {
    const { user } = useAuth();
        ...
        <DashboardLayout>
            <div className="cuadro-consulta-container">
                <div className="consulta-header">
                    <h1>📊 Consulta de Cuadro de Notas</h1>
                    <p className="subtitle">
                        Visualización del cuadro auxiliar de notas (solo lectura) - Registro Académico
                    </p>
                </div>
...
export default CuadroAuxiliarConsultaRegistro;
