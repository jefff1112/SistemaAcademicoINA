...
const ExportacionesExcel = () => {
    const { user } = useAuth();

    // Estados
    const [activeTab, setActiveTab] = useState('generar'); // generar | historial | estadisticas
            ...
            <div className="exportaciones-container">
                ...
                <div className="exportaciones-header">
                    ...
                    <p className="subtitle">
                        Genera reportes oficiales del INA, consulta el historial y descarga archivos previamente generados
                    </p>
                </div>
...
export default ExportacionesExcel;
