// Componente GestionConstancias (Direccion): emision, edicion, anulacion y consulta de constancias
// (estudio, conducta e incapacidad/permiso) para Direccion, Sub Director, Registro y Administrador.
...
const GestionConstancias = () => {
    ...
    return (
        <DashboardLayout title="Constancias - Direccion">
            <style>{`
